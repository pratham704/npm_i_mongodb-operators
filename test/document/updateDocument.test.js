import { connectToDatabase, updateDocument } from "../../src/index.js";
...
const run = async() => {
    try {
        ...
        const datas = await updateDocument("hey", schemaDefinition, { message: "type your message" }, { message: "updated text" }, )
        console.log(datas)
